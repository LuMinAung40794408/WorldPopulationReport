# Capital Reports Use cases

## USE CASE: All Capital Cities in the World Organised by Population (Largest to Smallest)

**Goal in Context:**
As a Developer, I must implement a report listing all capital cities by population worldwide.
...
**Trigger:** User initiates the Capital City Report feature to view a global list of capitals sorted by population.
...
## USE CASE: All Capital Cities in a Continent Organised by Population

**Goal in Context:**
As a Developer, I need to display capital cities in a continent sorted by population.
...
**Failed End Condition:** Database failure or missing data.
**Primary Actor:** Developer
**Trigger:** User runs the Capital City Report feature to analyze capital populations within a continent.
...
## USE CASE: All Capital Cities in a Region Organised by Population

**Goal in Context:**
As a Developer, I need to build a report for capital cities by region.
...
**Failed End Condition:** Database failure or missing data.
**Primary Actor:** Developer
**Trigger:** User activates the Capital City Report feature to view population data of capitals in a region.
